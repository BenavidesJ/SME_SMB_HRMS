...
/**
 * Plantilla HTML de bienvenida para nuevos colaboradores.
 *
      ...
      <table align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; margin:auto; background-color:#E7E7E7; border-radius:8px; box-shadow:0 2px 8px rgba(0,0,0,0.05); overflow:hidden;">
        <tr>
          <td style="background-color:#319E3F; padding:20px 30px; text-align:center;">
            <h1 style="color:#E7E7E7; font-size:24px; margin:0;">Bienvenido a <span style="color:#57E868;">Bio</span><span style="color:#105CC7;">Alquimia</span></h1>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:30px;">
            ...
            <p style="font-size:15px; line-height:1.6;">
              ¡Nos alegra darte la bienvenida a <strong>BioAlquimia</strong>! Ya puedes acceder al sistema con las siguientes credenciales:
            </p>
