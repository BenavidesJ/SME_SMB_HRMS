...
/**
 * Plantilla HTML para solicitud de horas extra.
 *
 * @param {Object} params - Parámetros del correo.
 * @param {string} params.solicitanteNombre - Nombre del solicitante.
 * @param {string} params.fechaTrabajo - Fecha de cuando se requieren las extra.
 * @param {string} params.horasSolicitadas - Cantidad de horas solicitadas.
...
export const plantillaSolicitudHorasExtra = ({
  ...
  <html lang="es">
    <head>
      ...
      <title>Solicitud de horas extra - BioAlquimia</title>
    </head>
        ...
        <tr>
          <td style="padding:30px;">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="margin:20px 0; border:1px solid #E7E7E7; border-radius:6px;">
              ...
              <tr>
                <td style="background-color:#C5C5C5; padding:12px 16px; font-weight:bold;">Fecha de trabajo</td>
                <td style="padding:12px 16px; color:#105CC7;">${fechaTrabajo}</td>
              </tr>
              <tr>
                <td style="background-color:#C5C5C5; padding:12px 16px; font-weight:bold;">Horas solicitadas</td>
                <td style="padding:12px 16px; color:#105CC7;">${horasSolicitadas}</td>
              </tr>
            </table>
