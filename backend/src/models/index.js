...
// Re-export models as named exports for backward compatibility
const {
  Aguinaldo: AguinaldoModel,
  BitacoraAuditoria: BitacoraAuditoriaModel,
  Canton: CantonModel,
  CausaLiquidacion: CausaLiquidacionModel,
  CicloPago: CicloPagoModel,
  Colaborador: ColaboradorModel,
  Contrato: ContratoModel,
  Deduccion: DeduccionModel,
  DeduccionPlanilla: DeduccionPlanillaModel,
  ...
  EvaluacionRubro: EvaluacionRubroModel,
  Feriado: FeriadoModel,
  HorarioLaboral: HorarioLaboralModel,
  Incapacidad: IncapacidadModel,
  JornadaDiaria: JornadaDiariaModel,
  Liquidacion: LiquidacionModel,
  MarcaAsistencia: MarcaAsistenciaModel,
  PeriodoPlanilla: PeriodoPlanillaModel,
  Planilla: PlanillaModel,
  Provincia: ProvinciaModel,
  Puesto: PuestoModel,
  Rol: RolModel,
  RubroEvaluacion: RubroEvaluacionModel,
  SaldoVacaciones: SaldoVacacionesModel,
  SolicitudHoraExtra: SolicitudHoraExtraModel,
  SolicitudPermisos: SolicitudPermisosModel,
  SolicitudVacaciones: SolicitudVacacionesModel,
  TipoContrato: TipoContratoModel,
  TipoHoraExtra: TipoHoraExtraModel,
  TipoIncapacidad: TipoIncapacidadModel,
  TipoJornada: TipoJornadaModel,
  TipoMarca: TipoMarcaModel,
  Usuario: UsuarioModel,
} = models;

export {
  AguinaldoModel as Aguinaldo,
  BitacoraAuditoriaModel as BitacoraAuditoria,
  CantonModel as Canton,
  CausaLiquidacionModel as CausaLiquidacion,
  CicloPagoModel as CicloPago,
  ColaboradorModel as Colaborador,
  ContratoModel as Contrato,
  DeduccionModel as Deduccion,
  DeduccionPlanillaModel as DeduccionPlanilla,
  DepartamentoModel as Departamento,
  DireccionModel as Direccion,
  DistritoModel as Distrito,
  EstadoModel as Estado,
  EstadoCivilModel as EstadoCivil,
  EvaluacionModel as Evaluacion,
  EvaluacionRubroModel as EvaluacionRubro,
  FeriadoModel as Feriado,
  HorarioLaboralModel as HorarioLaboral,
  IncapacidadModel as Incapacidad,
  JornadaDiariaModel as JornadaDiaria,
  LiquidacionModel as Liquidacion,
  MarcaAsistenciaModel as MarcaAsistencia,
  PeriodoPlanillaModel as PeriodoPlanilla,
  PlanillaModel as Planilla,
  ProvinciaModel as Provincia,
  PuestoModel as Puesto,
  RolModel as Rol,
  RubroEvaluacionModel as RubroEvaluacion,
  SaldoVacacionesModel as SaldoVacaciones,
  SolicitudHoraExtraModel as SolicitudHoraExtra,
  SolicitudPermisosModel as SolicitudPermisos,
  SolicitudVacacionesModel as SolicitudVacaciones,
  TipoContratoModel as TipoContrato,
  TipoHoraExtraModel as TipoHoraExtra,
  TipoIncapacidadModel as TipoIncapacidad,
  TipoJornadaModel as TipoJornada,
  TipoMarcaModel as TipoMarca,
